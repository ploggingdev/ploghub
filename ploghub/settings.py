"""
Django settings for ploghub project.
...
SECRET_KEY = os.environ['ploghub_secret_key']
...
WSGI_APPLICATION = 'ploghub.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ['ploghub_db_name'],
        'USER': os.environ['ploghub_db_user'],
        'PASSWORD': os.environ['ploghub_db_password'],
        'HOST': 'localhost',
        'PORT': '',
        'CONN_MAX_AGE' : 60
    }
